...
$result = "";
   if(isset($_POST['submit']))
   {
	...
	$body .= "</tr>";
	$body .= "<td style='border:none;'><strong>Phone Number:</strong> {$_POST['phone Number']}</td>";
	$body .= "</tr>";
	$body .= "<td style='border:none;'><strong>Email:</strong> {$_POST['email']}</td>";
	$body .= "</tr>";
	$body .= "<td style='border:none;'><strong>Subject:</strong> {$_POST['subject']}</td>";
	$body .= "</tr>";
	$body .= "<td style='border:none;'><strong>Services:</strong> {$_POST['services']}</td>";
	$body .= "</tr>";
	$body .= "<td style='border:none;'><strong>Budget:</strong> {$_POST['Budget']}</td>";
